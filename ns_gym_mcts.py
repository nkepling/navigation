...
class MCTS:
    ...
    """
    def __init__(self,env:gym.Env,state,d,m,c,gamma,heuristic=None) -> None:
        """
        Args:
...
if __name__ == "__main__":
    ...
    max_obstacles = 4 # maximum number of obstacles
    ...
    env = GridworldEnv(rewards,obstacles_map,start,goal,living_reward=-0.01)
    env = WrapForMCTS(env)
    ...
    while step < max_steps:
        ...
        # mcts = MCTS(env,observation,d=100,m=10,c=1,gamma=0.9)
